      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 no-print">
          ...
          <p className="text-purple-200 text-sm">
            Celestial Pattern Recognition ::: Neural Divination System
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 backdrop-blur-lg rounded-2xl p-8 border border-pink-300/20 print-content print-prediction">
              ...
              <div className="text-xs text-purple-300 italic">
                Generated by AI trained on astrological pattern recognition
              </div>
            </div>
            ...
            {dailyHoroscope && (
              <div className="bg-gradient-to-br from-cyan-900/50 to-blue-900/50 backdrop-blur-lg rounded-2xl p-8 border border-cyan-300/20 print-content print-prediction">
                ...
                <div className="text-xs text-cyan-300 italic">
                  Personalized transit analysis ::: Generated by AI pattern recognition
                </div>
              </div>
            )}
        ...
        <div className="mt-12 text-center text-xs text-purple-300/70 no-print">
          An artistic exploration of machine prediction systems in human culture ::: Blending ancient divination with machine learning ::: Birth details are sent to our AI / machine for analysis - they are not saved after your predictions have been generated
        </div>

        <div className="text-xs text-center text-purple-300/70">
          Artistic exploration created by <a href="https://kathodonnell.art">Kath O'Donnell</a> vibecoding with <a href="https://claude.ai">Claude</a> ::: All Rights Reserved
        </div>
